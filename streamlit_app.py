...
if params.get("mode") == "overlay":
    st.markdown("""
        <style>
            ...
            .ticker-target-block { display: flex; flex-direction: column; align-items: flex-start; gap: 1px; }
            .ticker-target-lbl { font-family: 'Roboto Condensed', sans-serif; font-size: 9px; letter-spacing: 2px; color: #ffffff; text-transform: uppercase; opacity: 0.75; }
            .ticker-target-val { font-size: 20px; font-weight: 700; color: #ff6b6b; line-height: 1; }
